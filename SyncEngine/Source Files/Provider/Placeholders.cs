...
//				//int bytesToWrite = (int)Math.Min(readBytes, remainingLength);
//				//bytesToWrite = Math.Min(bytesToWrite, stackSize);
...
//				HRESULT res = CfReportProviderProgress(opInfo.ConnectionKey, opInfo.TransferKey, total, completed);
//				res.ThrowIfFailed();
//			}
//		}
//	}
